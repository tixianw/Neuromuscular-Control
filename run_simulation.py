...
def get_activation(time, systems, controller=None, desired_curvature=None, desired_activation=None):
	# activation = np.zeros([3,systems[0].n_elems+1])
	activation = controller.neural_ctrl(time, systems[0], desired_curvature, desired_activation)
	return activation
